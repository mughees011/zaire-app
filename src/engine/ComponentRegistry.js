/**
 * ZAIRE OS Component Registry
 * Standardized DNA for the Interface Operating System
 */
...
export const ZaireComponentRegistry = [
  // CORE
...
].map(comp => ({ ...baseComponentDNA, ...comp }));

export const getComponentById = (id) => {
  return ZaireComponentRegistry.find(c => c.id === id);
};
